...
<body>
        ...
        <div class="container">
            <div class="grid grid--1x3">
                ...
                <div id="gold" class="card-container">
                    <div>
                        <h3 id="card-gold--text">Bilet Silver</h3>
                        <img class="card-img" src="./images/ticket_image.png" alt="" />
                        <ul>
                            <li class="list-checkmark">4,5 ore de training intensiv</li>
                            <li class="list-checkmark">
                ...
                <div class="card-container">
                    <div>
                        ...
                        <ul>
                            ...
                            <li class="list-checkmark">Loc in primele randuri, ccentral</li>
                            <li class="list-checkmark-green">
    ...
    <div class="container flex-center grid grid--1x3">
        <button class="btn--green-select">SELECT</button>
        <button class="btn--green-select">SELECT</button>
        <button class="btn--green-select">SELECT</button>
    </div>
    <!-- Price contnet -->
    <section>
        <div class="flex-center-column">
            <h2>Pretul</h2>
            <h3 class="price"><span id="thePrice">50</span>&nbsp;ron</h3>
        </div>
    </section>
    <!-- Footer -->
    <footer class="footer">
